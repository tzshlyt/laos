...
_start:
[extern kernel_main]       ; 声明 main 函数, 因为 main 函数在另外一个文件中，也因为链接后此代码在内核代码顶部，需要声明调用的函数。定义调用地址，必须和 kernel.c 文件 main 函数名字相同
call kernel_main           ; 调用 main, 编译器知道 main 函数的地址
jmp $